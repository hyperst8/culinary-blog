...
export const equipmentItems: Equipment[] = [
  ...
  },
  {
    id: "e4",
    title: "Stekepanne",
    description: "Kjøkkenets mest allsidige arbeidshest. En stekepanne av god kvalitet (enten støpejern, rustfritt stål eller slipp-lett) gir presis temperaturkontroll og utmerket bruning. Den er uunnværlig for steking, sautering og rask tilberedning av alt fra frokostegg til perfekt brunede biffer.",
    image: "/images/equipment_stekepanne.png",
    categorySlug: "stekepanne",
    useAreas: [
      { name: "Steking & bruning", icon: "Flame" },
      { name: "Sautering", icon: "CookingPot" },
      { name: "Pannekaker & egg", icon: "Egg" },
      { name: "Raske sauser", icon: "Soup" },
    ],
  },
  {
    id: "e5",
    title: "Mikrobølgeovn",
    description: "Mye mer enn bare en oppvarmingsmaskin. Den moderne mikrobølgeovnen bruker elektromagnetiske bølger til å varme opp vannmolekyler i maten, noe som gir ekstremt rask og effektiv tilberedning. Perfekt for hurtig damping av grønnsaker, smelting av ingredienser, rask baking, og selvfølgelig praktisk gjenoppvarming i en travel hverdag.",
    image: "/images/equipment_mikro.png",
    categorySlug: "mikro",
    useAreas: [
      { name: "Rask tining", icon: "Snowflake" },
      { name: "Dampede grønnsaker", icon: "Cloud" },
      { name: "Smelte smør & sjokolade", icon: "Droplet" },
      { name: "Rask oppvarming", icon: "Timer" },
    ],
  },
];
...
export const allRecipes: Recipe[] = [
  ...
  {
    id: "sp1",
    slug: "klassisk-smashburger",
    title: "Klassisk smashburger",
    description: "Saftig og sprøstekt smashburger laget i en glovarm stekepanne. Serveres med smeltet ost og dressing.",
    time: "10 min",
    calories: "580 kcal",
    mealType: "Middag",
    tags: ["Middag", "Fastfood"],
    categoryId: "c4",
    image: "/images/recipe_breakfast.png",
  },
  {
    id: "mb1",
    slug: "koppkake-med-sjokolade",
    title: "Koppkake med sjokolade",
    description: "En superrask og luftig sjokoladekake laget i en kopp på bare 90 sekunder i mikrobølgeovnen.",
    time: "3 min",
    calories: "340 kcal",
    mealType: "Dessert",
    tags: ["Dessert", "Søtt"],
  ...
  {
    id: "mb2",
    slug: "dampet-brokkoli-med-hvitlokssmor",
    title: "Dampet brokkoli med hvitløkssmør",
    description: "Damp brokkolien perfekt mør på få minutter i mikrobølgeovnen. Enkel og rask tilbehørsrett.",
    time: "5 min",
    calories: "120 kcal",
    mealType: "Tilbehør",
    tags: ["Tilbehør", "Sunt"],
