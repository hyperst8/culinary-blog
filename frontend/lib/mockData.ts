...
export const singleRecipe: Recipe = {
  ...
  description: "En sunnere og utrolig rask måte å lage klassisk 'fried chicken' på. Airfryeren gir en fantastisk sprø skorpe uten behov for store mengder olje.",
  time: '30 min',
  calories: '520 kcal',
  mealType: 'Middag',
  tags: ['Middag'],
  ...
  instructions: [
    {
      ...
      description: 'Legg kyllingbitene i en bolle med kulturmelk. La det marinere i kjøleskapet i minst 30 minutter (helst lenger for saftigere resultat).',
    },
    {
      title: 'Forbered paneringen',
      description: 'I en annen vid bolle, bland sammen mel, paprikapulver, hvitløkspulver, salt og en god klype sort pepper.',
    },
    {
      title: 'Paner kyllingen',
      description: 'Ta en og en kyllingbit ut av marinaden (la overflødig væske renne av) og dekk den grundig i melblandingen. Trykk melet litt fast slik at det sitter godt.',
    },
    {
      title: 'Steking i Airfryer',
      description: 'Forvarm airfryeren til 200°C. Spray kyllingbitene lett med matolje på begge sider. Legg dem i kurven (ikke overfyll) og stek i ca. 18-20 minutter. Snu dem halvveis og spray ev. med litt mer olje der det er tørt mel.',
    },
  ],
  tips: [
    {
      type: 'equipment',
      title: 'Utstyrtips',
      description: 'For ekstra sprøhet i airfryeren er matoljespray alfa og omega. Airfryeren trenger *litt* fett for å skape skorpen, ellers vil melet bare bli tørt og pudrete. Spray jevnt, men lett.',
    },
    {
      type: 'warning',
      title: 'Unngå overfylling',
      description: 'La det være rom mellom bitene i kurven for optimal luftsirkulasjon.',
    },
  ],
};
