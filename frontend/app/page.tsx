    ...
    <div className="flex flex-col gap-24 pb-24">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="flex flex-col gap-6 max-w-xl relative">
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight text-text-tertiary leading-[1.1]">
              Matlaging gjort enkelt med{" "}
              <span className="text-brand-600">riktig utstyr</span>
            </h1>
            <p className="text-lg text-text-secondary leading-relaxed max-w-md">
              Oppdag en verden av kulinariske muligheter. Vi bygger broen mellom
      ...
      <section className="container">
        <div className="flex flex-col items-center text-center gap-2 mb-10">
          <h2 className="text-3xl font-bold text-text-tertiary">
            Vårt kjøkkenutstyr
          </h2>
          <p className="text-text-secondary">
            Finn det perfekte verktøyet for din neste rett
          </p>
        </div>
      ...
      <section className="container">
        <div className="flex items-end justify-between mb-8">
          ...
          <Link
            href="/oppskrifter"
            className="hidden sm:flex items-center gap-1 font-semibold text-brand-600 hover:text-brand-700 transition-colors"
          >
        ...
        <Link
          href="/oppskrifter"
          className="sm:hidden flex items-center justify-center gap-1 font-semibold text-brand-600 hover:text-brand-700 transition-colors mt-8"
        >
          Se alle <ArrowRight className="w-4 h-4" />
        </Link>
      </section>
